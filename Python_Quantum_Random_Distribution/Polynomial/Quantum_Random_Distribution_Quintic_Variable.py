...
def Quantum_Random_Distribution_Excel_Quintic_Variable(Prob_Value,Pixel_Size,Zero,One,Two,Three,Four,Five,Six,Seven,square_int,Print_Horizontal,Print_Vertical):
